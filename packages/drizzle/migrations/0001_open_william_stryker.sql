...
CREATE INDEX "locations_idx" ON "locations" USING btree ("id");--> statement-breakpoint
CREATE INDEX "locations_created_at_idx" ON "locations" USING btree ("createdAt");--> statement-breakpoint
CREATE INDEX "locations_updated_at_idx" ON "locations" USING btree ("updatedAt");--> statement-breakpoint
