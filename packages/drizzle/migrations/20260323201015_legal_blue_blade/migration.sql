...
CREATE TABLE "lte_cells" (
	...
	CONSTRAINT "lte_tac_check" CHECK ("tac" BETWEEN 0 AND 65535),
...
CREATE TABLE "user_lists" (
	...
	CONSTRAINT "user_lists_stations_is_object" CHECK (jsonb_typeof("stations") = 'object'),
