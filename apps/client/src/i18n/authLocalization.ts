...
export const plPLAuthLocalization: Partial<AuthLocalization> = {
  ...
  USERNAME_DESCRIPTION: "Wpisz nazwę użytkownika, której chcesz używać do logowania.",
  USERNAME_INSTRUCTIONS: "Od 3 do 25 znaków.",
  ...
  USERNAME_IS_ALREADY_TAKEN: "Ta nazwa użytkownika jest już zajęta.",
