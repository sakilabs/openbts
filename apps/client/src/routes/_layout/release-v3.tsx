...
- Aby zainstalować BTSearch v3 jako aplikację typu PWA, otwórz stronę [btsearch.pl](https://btsearch.pl) w przeglądarce telefonu. Następnie znajdź w opcjach przeglądarki funkcję "Dodaj do ekranu głównego" (lub podobnie). Wówczas serwis zostanie dodany do pamięci smartfonu jako niezależna aplikacja.
