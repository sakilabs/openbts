...
export const RadioLinePopupContent = memo(function RadioLinePopupContent({ radioLine, coordinates, onOpenDetails }: RadioLinePopupContentProps) {
	...
	return (
		<div className="w-72 text-sm">
			<div className="px-3 py-2 border-b border-border/50">
				<h3 className="font-medium text-sm leading-tight pr-4">{t("radiolines.title", { id: radioLine.id })}</h3>
			</div>
