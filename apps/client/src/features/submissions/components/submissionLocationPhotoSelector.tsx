            ...
            return (
              ...
              >
                <div className="relative aspect-square">
                  ...
                  <button
                    type="button"
                    className="absolute bottom-1 right-1 size-5 rounded bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity hover:bg-black/70"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    <HugeiconsIcon icon={ArrowExpand01Icon} className="size-3 text-white" />
                  </button>
                </div>
